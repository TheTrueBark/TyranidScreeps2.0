var statsConsole = {
    ...
    displayStats: function (opts = {}) {
        ...
        let secondLineName = ["GCL" + (Game.gcl.level + 1) + " - " + ((gclProgress / gclProgressTotal) * 100).toFixed(0) + "%"];
        let secondLineStat = [((gclProgress / gclProgressTotal) * 100).toFixed(2) + percent];
        if (useProgressBar === "yes") {
            secondLineStat = [_.repeat(progressBar, ((gclProgress / gclProgressTotal) * (boxWidth / 4 - 2)))];
        }
